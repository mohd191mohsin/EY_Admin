<?php
    ...
    $screen_name=$this->session->userdata('logged_in_admin_data')['screen_name'];
    $email=$this->session->userdata('logged_in_admin_data')['email'];
    $role=$this->session->userdata('logged_in_admin_data')['role'];
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="header">
            <div class="header-left">
                <a href="<?=base_url('admin/dashboard'); ?>" class="logo">
                    <!-- <img src="<?=base_url(); ?>/assets/img/logo.jpeg" width="" height="55px" alt=""> -->
                    <svg id="a" data-name="Artwork" xmlns="http://www.w3.org/2000/svg" height="45" class="cmp-logo__image" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1000.5 402.22">
                        <defs>
                            <style>
